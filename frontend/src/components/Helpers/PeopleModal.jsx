...
const PeopleModal = ({ show, handleClose, title, initialData }) => {
    ...
    useEffect(() => {
        if (show) {
            ...
            setImagePreview(initialData?.profilePicture || 'img/avatars/avatar.jpg'); // Use initial data for image preview
...
console.log(initialData)
    ...
    const handleFileChange = useCallback((e) => {
        ...
        if (file) {
            ...
            if (!isImage) {
                ...
                setImagePreview('img/avatars/avatar.jpg'); // Reset the image preview
    ...
    const onSave = () => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            ...
            data.append('reminder', formData.reminder);
            data.append('status', formData.active);
            if (selectedFile) {
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-10">
                                            <CustomDropdown
                                                options={typeOptions}
                                                value={formData.type || ""}
                                                onChange={(selectedType) => handleInputChange({ target: { name: 'type', value: selectedType.value } })}
                                                error={errors.type}
                                            />
                                        </div>
                                    </div>
